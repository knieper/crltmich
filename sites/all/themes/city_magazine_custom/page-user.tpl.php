      ...
      <div id="header-group-wrapper-sub-inner" class="header-group-wrapper-sub-inner full-width">
        <div id="header-group" class="header-group row <?php print $grid_width; ?>">
          <div id="header-group-inner" class="header-group-inner inner clearfix">
            ...
            <?php if ($navigation_right || $primary_links_tree): ?>
            <div id="navigation">
              <div id="navigation-inner">
                <div id="navigation-sub-inner">
                  <?php print theme('grid_row', $navigation_right, 'navigation-right'); ?>
            ...
            <?php if ($preface_upper_top): ?>
            <!-- preface-top row: width = grid_width -->
            <?php print theme('grid_row', $preface_upper_top, 'preface-upper-top', 'full-width', $grid_width); ?>
            <div class="shadow-image pngfix"><img src="<?php print base_path(). path_to_theme() ?>/images/preface-upper-shadow.png"  height="43" width="100%" alt="shadow" /></div>
            <?php endif; ?>

          </div><!-- /header-group-inner -->
        </div><!-- /header-group -->
      <div class="head-shadow">&nbsp;</div>
      </div></div></div><!-- /header-group-sub-wrapper, /header-group-inner-wrapper, /header-group-wrapper -->
...
-->      <!-- preface-top row: width = grid_width -->
      ...
      <?php print theme('grid_row', $postscript_bottom_top, 'postscript-bottom-top', 'full-width', $grid_width); ?>
